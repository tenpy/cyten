                                 ...
                                 std::optional<std::string> device)
{
    ...
    if (!dtype.is_real) {
        res = res + /* FIXME: Constant complex: 1j */ *np.random.normal(
                                  ...
                                  std::optional<std::string> device)
{
    ...
    if (!dtype.is_real) {
        res = res + /* FIXME: Constant complex: 1j */ *np.random.uniform(
...
std::string
NumpyBlockBackend::get_backend_name()
{
    // FIXME: implement
}
...
NumpyBlockBackend::possible_svd_algorithms()
{
    // FIXME: implement
}

bool
NumpyBlockBackend::is_correct_block_type(const BlockCPtr& block)
{
    // FIXME: implement
}

const NumpyBlockBackend::Block*
NumpyBlockBackend::ptr(const BlockCPtr& b)
{
    // FIXME: implement
}
