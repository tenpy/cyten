...
# FIXME reframe docs
# FIXME move some bits to Symmetry?
class FactorSymmetry(metaclass=ABCMeta):
...
# FIXME rename, reframe
# FIMXE no longer subclass!
class Symmetry:
...
double_semion_category = Symmetry([ZNAnyonCategory2(2, 0), ZNAnyonCategory2(2, 1)])
