...
// CHECKME: the following was generated by .cursor/skills/pybind11-codegen/pybind11_codegen.py gen_cpp_declaration --py-name LegPipe --header-file include/cyten/symmetries/spaces.h

/// A group of legs, i.e. resulting from :func:`~cyten.tensors.combine_legs`.
class LegPipe : public Leg {
public:
public:
    LegPipe(Sequence_Leg_ legs, bool is_dual=false, bool combine_cstyle=true);
    virtual ~LegPipe() = default;
    /// property getter
    virtual Leg::Ptr get_dual() override;
    /// property getter
    virtual bool get_is_trivial() override;
    /// property getter
    virtual std::vector<Leg::Ptr> get_flat_legs() override;
    /// property getter
    virtual std::vector<Leg::Ptr> get_flat_spaces() override;
    /// property getter
    virtual int64 get_num_flat_legs() override;
    /// Perform sanity checks.
    virtual TYPEOF_return test_sanity() override;
    virtual TYPEOF_return as_Space() override;
    /// property getter
    virtual Leg::Ptr get_dual() override;
    /// property getter
    virtual bool get_is_trivial() override;
    ...
    /// property getter
    virtual int64 get_num_flat_legs() override;
    virtual list_int_ _flat_leg_permutation(int64 offset=0) override;
    virtual TYPEOF_return set_basis_perm(
        std::optional<std::vector<int64>> basis_perm=UNSPECIFIED,
        std::optional<std::vector<int64>> inverse_basis_perm=UNSPECIFIED
    ) override;
    virtual bool operator==(TYPEOF_other other) override;
    TYPEOF_return operator[](TYPEOF_idx idx);
    TYPEOF_return __iter__();
    TYPEOF_return __len__();
