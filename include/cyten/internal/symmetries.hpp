...
template<int N>
Sector
_compress_sector_fixed(std::array<Sector, N> decompressed, std::array<int, N> const& bit_lengths)
{
    Sector compressed = 0;
    int shift = 0;
...
template<int N>
std::array<Sector, N>
_decompress_sector_fixed(Sector compressed, std::array<int, N> const& bit_lengths)
{
