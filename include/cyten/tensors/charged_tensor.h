...
/// leg is ambiguous.
///
/// @param invariant_part The symmetry-invariant part. the charge leg is the its ``domain.spaces[0]``.
/// @param charged_state Either ``None``, or a backend-specific block of shape ``(charge_leg.dim,)``, which specifies a state on the charge leg.
...
/// @returns inv_domain: TensorProduct The domain of the invariant part charge_leg: Space The charge_leg of the resulting ChargedTensor
