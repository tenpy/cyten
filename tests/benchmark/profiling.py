...
Call this file with arguments, e.g::
    ...
    python profiling.py -m tensordot_cyten tensordot_numpy -l 2 -s 20 -S 50 -q 1 1
...
fn_template = (
    '{mod_name!s}_profile_S_{size:d}_s_{sectors:d}_l_{legs:d}_mod_q_{mod_q_str}_{symmetry_backend}_{block_backend}.prof'
)
...
if __name__ == '__main__':
    ...
    from benchmark import _add_common_args
