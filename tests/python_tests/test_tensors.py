...
def test_permute_legs(
    ...
    #
    # if T.has_pipes and isinstance(T.backend, backends.AbelianBackend):
    #     pytest.xfail('Unresolved indexing errors')
    ...
    res2 = tensors.permute_legs(res, codomain2, domain2, levels2, bend_right=True)
    res2.test_sanity()
