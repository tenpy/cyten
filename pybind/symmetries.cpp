...
class PySymmetry : public Symmetry
{
  public:
    ...
    {
        PYBIND11_OVERRIDE(bool, SymmetryBase, can_be_dropped, );
    }
    std::string group_name() const override
    {
        PYBIND11_OVERRIDE_PURE(std::string, SymmetryBase, group_name, );
    }
    Sector trivial_sector() const override
    {
        PYBIND11_OVERRIDE_PURE(Sector, SymmetryBase, trivial_sector, );
    }
    bool is_valid_sector(Sector sector) const override
    {
        PYBIND11_OVERRIDE_PURE(bool, SymmetryBase, is_valid_sector, sector);
    }
    SectorArray fusion_outcomes(Sector a, Sector b) const override
    {
        PYBIND11_OVERRIDE_PURE(SectorArray, SymmetryBase, fusion_outcomes, a, b);
    }
    std::string __repr__() const override
    {
        PYBIND11_OVERRIDE_PURE(std::string, SymmetryBase, __repr__, );
    }
    bool is_same_symmetry(Symmetry const& other) const override
    {
        PYBIND11_OVERRIDE_PURE(bool, SymmetryBase, is_same_symmetry, other);
    }
    Sector dual_sector(Sector a) const override
    {
        PYBIND11_OVERRIDE_PURE(Sector, SymmetryBase, dual_sector, a);
    }
    cyten_int _n_symbol(Sector a, Sector b, Sector c) const override
    {
        PYBIND11_OVERRIDE_PURE(cyten_int, SymmetryBase, _n_symbol, a, b, c);
    }
    py::array _f_symbol(Sector a, Sector b, Sector c, Sector d, Sector e, Sector f) const override
    {
        PYBIND11_OVERRIDE_PURE(py::array, SymmetryBase, _f_symbol, a, b, c, d, e, f);
    }
    py::array _r_symbol(Sector a, Sector b, Sector c) const override
    {
        PYBIND11_OVERRIDE_PURE(py::array, SymmetryBase, _r_symbol, a, b, c);
    }
    py::array _fusion_tensor(Sector a, Sector b, Sector c, bool Z_a, bool Z_b) const override
    {
        PYBIND11_OVERRIDE(py::array, SymmetryBase, _fusion_tensor, a, b, c, Z_a, Z_b);
    }
    py::array Z_iso(Sector a) override
    {
        PYBIND11_OVERRIDE_PURE(py::array, SymmetryBase, Z_iso, a);
    }
    SectorArray all_sectors() const override
    {
        PYBIND11_OVERRIDE(SectorArray, SymmetryBase, all_sectors, );
    }
    Sector compress_sector(std::vector<Sector> const& decompressed) const override
    {
        PYBIND11_OVERRIDE(Sector, SymmetryBase, compress_sector, decompressed);
    }
    std::vector<Sector> decompress_sector(Sector compressed) const override
    {
        PYBIND11_OVERRIDE(std::vector<Sector>, SymmetryBase, decompress_sector, compressed);
    }
    bool are_valid_sectors(SectorArray const& sectors) const override
    {
        PYBIND11_OVERRIDE(bool, SymmetryBase, are_valid_sectors, sectors);
    }
    SectorArray fusion_outcomes_broadcast(SectorArray const& a,
                                          SectorArray const& b) const override
    {
        PYBIND11_OVERRIDE(SectorArray, SymmetryBase, fusion_outcomes_broadcast, a, b);
    }
    SectorArray _multiple_fusion_broadcast(std::vector<SectorArray> const& sectors) const override
    {
        PYBIND11_OVERRIDE(SectorArray, SymmetryBase, _multiple_fusion_broadcast, sectors);
    }
    bool can_fuse_to(Sector a, Sector b, Sector c) const override
    {
        PYBIND11_OVERRIDE(bool, SymmetryBase, can_fuse_to, a, b, c);
    }
    cyten_int sector_dim(Sector a) const override
    {
        PYBIND11_OVERRIDE(cyten_int, SymmetryBase, sector_dim, a);
    }
    std::vector<cyten_int> sector_dim(SectorArray const& a) const override
    {
        PYBIND11_OVERRIDE(std::vector<cyten_int>, SymmetryBase, sector_dim, a);
    }
    cyten_float qdim(Sector a) const override
    {
        PYBIND11_OVERRIDE(cyten_float, SymmetryBase, qdim, a);
    }
    std::vector<cyten_float> qdim(SectorArray const& a) const override
    {
        PYBIND11_OVERRIDE(std::vector<cyten_float>, SymmetryBase, qdim, a);
    }
    std::string sector_str(Sector a) const override
    {
        PYBIND11_OVERRIDE(std::string, SymmetryBase, sector_str, a);
    }
    cyten_int frobenius_schur(Sector a) const override
    {
        PYBIND11_OVERRIDE(cyten_int, SymmetryBase, frobenius_schur, a);
    }
    py::array _b_symbol(Sector a, Sector b, Sector c) const override
    {
        PYBIND11_OVERRIDE(py::array, SymmetryBase, _b_symbol, a, b, c);
    }
    py::array _c_symbol(Sector a, Sector b, Sector c, Sector d, Sector e, Sector f) const override
    {
        PYBIND11_OVERRIDE(py::array, SymmetryBase, _c_symbol, a, b, c, d, e, f);
    }
};
...
bind_symmetries(py::module_& m)
{
    ...
    py::enum_<FusionStyle>(m, "FusionStyle", py::arithmetic(), R"pydoc(
      ...
      .value("multiple_unique",
             FusionStyle::multiple_unique,
             "Every sector appears at most once in pairwise fusion, ``N_symbol in [0, 1]``.")
      .value("general", FusionStyle::general, "No assumptions, ``N_symbol in [0, 1, 2, 3, ...]``.")
      .export_values();
