...
bind_tensor_backend(py::module_& m)
{
    ...
    py::class_<TensorBackend, PyTensorBackend, py::smart_holder> tensor_backend(m, "TensorBackend");
...
blocks.
    ...
    tensor_backend
      .def(py::init<std::shared_ptr<BlockBackend>>(), py::arg("block_backend"))
    ...
    .def("test_tensor_sanity", &TensorBackend::test_tensor_sanity,
        py::arg("a"),
        py::arg("is_diagonal"),
        R"pydoc(
    ...
    .def("test_mask_sanity", &TensorBackend::test_mask_sanity,
        py::arg("a")
        )
    .def("make_pipe", &TensorBackend::make_pipe,
        py::arg("legs"),
        py::arg("is_dual"),
        py::arg("pipe") = py::none(),
        R"pydoc(
    ...
    .def("act_block_diagonal_square_matrix", &TensorBackend::act_block_diagonal_square_matrix,
        py::arg("a"),
        py::arg("block_method"),
        py::arg("dtype_map"),
        R"pydoc(
    ...
    .def("add_trivial_leg", &TensorBackend::add_trivial_leg,
        py::arg("a"),
        py::arg("legs_pos"),
    ...
    .def("almost_equal", &TensorBackend::almost_equal,
        py::arg("a"),
        py::arg("b"),
        py::arg("rtol"),
        py::arg("atol")
        )
    .def("apply_mask_to_DiagonalTensor", &TensorBackend::apply_mask_to_DiagonalTensor,
        py::arg("tensor"),
        py::arg("mask")
        )
    .def("combine_legs", &TensorBackend::combine_legs,
        py::arg("tensor"),
    ...
    .def("compose", &TensorBackend::compose,
        py::arg("a"),
        py::arg("b"),
        R"pydoc(
    ...
    .def("copy_data", &TensorBackend::copy_data,
        py::arg("a"),
    ...
    .def("dagger", &TensorBackend::dagger,
        py::arg("a")
        )
    .def("data_item", &TensorBackend::data_item,
        py::arg("a"),
        R"pydoc(
    ...
    .def("diagonal_all", &TensorBackend::diagonal_all,
        py::arg("a"),
        "Assumes a boolean DiagonalTensor. If all entries are True."
        )
    .def("diagonal_any", &TensorBackend::diagonal_any,
        py::arg("a"),
        "Assumes a boolean DiagonalTensor. If any entry is True."
        )
    .def("diagonal_elementwise_binary", &TensorBackend::diagonal_elementwise_binary,
        py::arg("a"),
        py::arg("b"),
        py::arg("func"),
        py::arg("func_kwargs"),
    ...
    .def("diagonal_elementwise_unary", &TensorBackend::diagonal_elementwise_unary,
        py::arg("a"),
        py::arg("func"),
        py::arg("func_kwargs"),
    ...
    .def("diagonal_from_block", &TensorBackend::diagonal_from_block,
        py::arg("a"),
        py::arg("co_domain"),
        py::arg("tol"),
        "The DiagonalData from a 1D block in *internal* basis order."
        )
    .def("diagonal_from_sector_block_func", &TensorBackend::diagonal_from_sector_block_func,
        py::arg("func"),
        py::arg("co_domain"),
        R"pydoc(
    ...
    .def("diagonal_tensor_from_full_tensor", &TensorBackend::diagonal_tensor_from_full_tensor,
        py::arg("a"),
        py::arg("tol") = 1e-12,
        R"pydoc(
    ...
    .def("diagonal_tensor_trace_full", &TensorBackend::diagonal_tensor_trace_full,
        py::arg("a")
        )
    .def("diagonal_tensor_to_block", &TensorBackend::diagonal_tensor_to_block,
        py::arg("a"),
        R"pydoc(
    ...
    .def("diagonal_to_mask", &TensorBackend::diagonal_to_mask,
        py::arg("tens"),
        R"pydoc(
    ...
    .def("diagonal_transpose", &TensorBackend::diagonal_transpose,
        py::arg("tens"),
        "Transpose a diagonal tensor. Also return the new leg ``tens.leg.dual``"
        )
    .def("eigh", &TensorBackend::eigh,
        py::arg("a"),
        py::arg("new_leg_dual"),
        py::arg("sort") = py::none(),
        R"pydoc(
    ...
    .def("eye_data", &TensorBackend::eye_data,
        py::arg("co_domain"),
        py::arg("dtype"),
        py::arg("device"),
        R"pydoc(
    ...
    .def("from_dense_block", &TensorBackend::from_dense_block,
        py::arg("a"),
        py::arg("codomain"),
        py::arg("domain"),
        py::arg("tol"),
    ...
    .def("from_dense_block_trivial_sector", &TensorBackend::from_dense_block_trivial_sector,
        py::arg("block"),
        py::arg("leg"),
        R"pydoc(
    ...
    .def("from_grid", &TensorBackend::from_grid,
        py::arg("grid"),
        py::arg("new_codomain"),
        py::arg("new_domain"),
    ...
    .def("from_random_normal", &TensorBackend::from_random_normal,
        py::arg("codomain"),
        py::arg("domain"),
        py::arg("sigma"),
        py::arg("dtype"),
    ...
    .def("from_sector_block_func", &TensorBackend::from_sector_block_func,
        py::arg("func"),
        py::arg("codomain"),
        py::arg("domain"),
        R"pydoc(
    ...
    .def("from_tree_pairs", &TensorBackend::from_tree_pairs,
        py::arg("trees"),
        py::arg("codomain"),
        py::arg("domain"),
        py::arg("dtype"),
    ...
    .def("full_data_from_diagonal_tensor", &TensorBackend::full_data_from_diagonal_tensor,
        py::arg("a")
        )
    .def("full_data_from_mask", &TensorBackend::full_data_from_mask,
        py::arg("a"),
        py::arg("dtype"),
        "May assume that the mask is a projection."
        )
    .def("get_device_from_data", &TensorBackend::get_device_from_data,
        py::arg("a"),
        "Extract the device from the data object"
        )
    .def("get_dtype_from_data", &TensorBackend::get_dtype_from_data,
        py::arg("a")
        )
    .def("get_element", &TensorBackend::get_element,
        py::arg("a"),
        py::arg("idcs"),
        R"pydoc(
    ...
    .def("get_element_diagonal", &TensorBackend::get_element_diagonal,
        py::arg("a"),
        py::arg("idx"),
        R"pydoc(
    ...
    .def("get_element_mask", &TensorBackend::get_element_mask,
        py::arg("a"),
        py::arg("idcs"),
        R"pydoc(
        Get a single scalar element from a diagonal tensor.
    ...
    .def("inner", &TensorBackend::inner,
        py::arg("a"),
        py::arg("b"),
        py::arg("do_dagger"),
        "tensors.inner on SymmetricTensors"
        )
    .def("inv_part_from_dense_block_single_sector", &TensorBackend::inv_part_from_dense_block_single_sector,
        py::arg("vector"),
        py::arg("space"),
        py::arg("charge_leg"),
        R"pydoc(
    ...
    .def("inv_part_to_dense_block_single_sector", &TensorBackend::inv_part_to_dense_block_single_sector,
        py::arg("tensor"),
        R"pydoc(
    ...
    .def("linear_combination", &TensorBackend::linear_combination,
        py::arg("a"),
        py::arg("v"),
        py::arg("b"),
        py::arg("w"),
    ...
    .def("lq", &TensorBackend::lq,
        py::arg("tensor"),
        py::arg("new_co_domain")
        )
    .def("mask_binary_operand", &TensorBackend::mask_binary_operand,
        py::arg("mask1"),
        py::arg("mask2"),
        py::arg("func"),
        R"pydoc(
    ...
    .def("mask_contract_large_leg", &TensorBackend::mask_contract_large_leg,
        py::arg("tensor"),
        py::arg("mask"),
        py::arg("leg_idx"),
        R"pydoc(
    ...
    .def("mask_contract_small_leg", &TensorBackend::mask_contract_small_leg,
        py::arg("tensor"),
        py::arg("mask"),
        py::arg("leg_idx"),
        R"pydoc(
    ...
    .def("mask_dagger", &TensorBackend::mask_dagger,
        py::arg("mask")
        )
    .def("mask_from_block", &TensorBackend::mask_from_block,
        py::arg("a"),
        py::arg("large_leg"),
        R"pydoc(
    ...
    .def("mask_to_block", &TensorBackend::mask_to_block,
        py::arg("a"),
        "As a block of the large_leg, in *internal* basis order."
        )
    .def("mask_to_diagonal", &TensorBackend::mask_to_diagonal,
        py::arg("a"),
        py::arg("dtype")
        )
    .def("mask_transpose", &TensorBackend::mask_transpose,
        py::arg("tens"),
        R"pydoc(
    ...
    .def("mask_unary_operand", &TensorBackend::mask_unary_operand,
        py::arg("mask"),
        py::arg("func"),
        R"pydoc(
    ...
    .def("move_to_device", &TensorBackend::move_to_device,
        py::arg("a"),
        py::arg("device"),
        R"pydoc(
    ...
    .def("mul", &TensorBackend::mul,
        py::arg("a"),
        py::arg("b")
        )
    .def("norm", &TensorBackend::norm,
        py::arg("a"),
        "Norm of a tensor. order has already been parsed and is a number"
        )
    .def("outer", &TensorBackend::outer,
        py::arg("a"),
        py::arg("b"),
        R"pydoc(
    ...
    .def("partial_compose", &TensorBackend::partial_compose,
        py::arg("a"),
        py::arg("b"),
        py::arg("a_first_leg"),
        py::arg("new_codomain"),
    ...
    .def("partial_trace", &TensorBackend::partial_trace,
        py::arg("tensor"),
        py::arg("pairs"),
        py::arg("levels"),
        R"pydoc(
    ...
    .def("permute_legs", &TensorBackend::permute_legs,
        py::arg("a"),
    ...
    .def("reduce_DiagonalTensor", &TensorBackend::reduce_DiagonalTensor,
        py::arg("tensor"),
        py::arg("block_func"),
        py::arg("func"),
        R"pydoc(
    ...
    .def("scale_axis", &TensorBackend::scale_axis,
        py::arg("a"),
        py::arg("b"),
        py::arg("leg"),
        R"pydoc(
    ...
    .def("split_legs", &TensorBackend::split_legs,
        py::arg("a"),
        py::arg("leg_idcs"),
        py::arg("new_codomain"),
        py::arg("new_domain"),
    ...
    .def("squeeze_legs", &TensorBackend::squeeze_legs,
        py::arg("a"),
        py::arg("idcs"),
        "Assume the legs at given indices are trivial and get rid of them"
        )
    .def("supports_symmetry", &TensorBackend::supports_symmetry,
        py::arg("symmetry")
        )
    .def("svd", &TensorBackend::svd,
        py::arg("a"),
        py::arg("new_co_domain"),
        py::arg("algorithm")
        )
    .def("state_tensor_product", &TensorBackend::state_tensor_product,
        py::arg("state1"),
        py::arg("state2"),
        py::arg("pipe"),
        R"pydoc(
    ...
    .def("to_block_backend", &TensorBackend::to_block_backend,
        py::arg("data"),
        py::arg("block_backend"),
        py::arg("dtype") = py::none(),
        py::arg("device") = py::none()
        )
    .def("to_dense_block", &TensorBackend::to_dense_block,
        py::arg("a"),
        R"pydoc(
    ...
    .def("to_dense_block_trivial_sector", &TensorBackend::to_dense_block_trivial_sector,
        py::arg("tensor"),
        R"pydoc(
    ...
    .def("to_dtype", &TensorBackend::to_dtype,
        py::arg("a"),
        py::arg("dtype"),
        "Cast to given dtype. No copy if already has dtype."
        )
    .def("trace_full", &TensorBackend::trace_full,
        py::arg("a"),
        py::arg("idcs1"),
        py::arg("idcs2")
        )
    .def("truncate_singular_values", &TensorBackend::truncate_singular_values,
        py::arg("S"),
        py::arg("chi_max"),
        py::arg("chi_min"),
    ...
    .def("_truncate_singular_values_selection", &TensorBackend::_truncate_singular_values_selection,
        py::arg("S"),
        py::arg("qdims"),
        py::arg("chi_max"),
        py::arg("chi_min"),
    ...
    .def("zero_data", &TensorBackend::zero_data,
        py::arg("codomain"),
        py::arg("domain"),
        py::arg("dtype"),
        py::arg("device"),
    ...
    .def("zero_diagonal_data", &TensorBackend::zero_diagonal_data,
        py::arg("co_domain"),
        py::arg("dtype"),
        py::arg("device")
        )
    .def("zero_mask_data", &TensorBackend::zero_mask_data,
        py::arg("large_leg"),
        py::arg("device")
        )
    .def("is_real", &TensorBackend::is_real,
        py::arg("a"),
        R"pydoc(
    ...
    .def("save_hdf5", &TensorBackend::save_hdf5,
        py::arg("hdf5_saver"),
        py::arg("h5gr"),
        py::arg("subpath")
        )
    .def_static("from_hdf5", &TensorBackend::from_hdf5,
        py::arg("hdf5_loader"),
        py::arg("h5gr"),
        py::arg("subpath")
        )
