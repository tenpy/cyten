...
{
    py::native_enum<FusionStyle> fusion_enum(
      m, "FusionStyle", "enum.IntEnum", DOC(cyten, FusionStyle));
    ...
    py::native_enum<BraidingStyle> braid_enum(
      m, "BraidingStyle", "enum.IntEnum", DOC(cyten, BraidingStyle));
