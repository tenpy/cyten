...
7. **Docstrings** — See [docstring_porting.md](docstring_porting.md) (dual-language policy from [tenpy/cyten#242](https://github.com/tenpy/cyten/issues/242); `///` + per-header `pybind/docstrings/` + `DOC` / `R"pydoc"`).
